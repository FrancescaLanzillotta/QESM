...
//                            MuApp muApp = new MuApp(i, invocationRate, functionData, stateData);
//                            muApps.add(muApp);
//                        }
//
...
//                        if (light){
//                            if (muApps.size() < nMu){
//                                muApps.add(new MuApp(muApps.size(), 10, 1, 0));
//                            } else {
//                                lambdaApps.add(new LambdaApp(lambdaApps.size(), 10, 1, 0));
//                            }
//                        } else {
//                            if (muApps.size() < nMu){
//                                muApps.add(new MuApp(muApps.size(), 1, 100, 10));
//                            } else {
                ...
                for (int k = 0; k < functionDatas.length; k++){
                    for (int exp = 0; exp < experiments; exp++){
                        ...
                        for (int i = 0; i < nMu; i++){
                            ...
                            muApps.add(new MuApp(i, invocationRate, functionData, stateData));
                        }
...
//                            }
//                            if (muApps.size() < nMu){
//                                muApps.add(new MuApp(muApps.size(), invocationRate, functionData, stateData));
...
//        ArrayList<ComputeNode> computeNodes = Utils.createNetworkTopology(100, 0, 0.5);
//        HashSet<MuApp> muApps = new HashSet<>();
//        for (int i = 0; i < 100; i++){
//            muApps.add(new MuApp(i, 1, 100, 10));
//        }
//        Orchestrator o =new Orchestrator(computeNodes, muApps, new HashSet<>(), 1);
//        for (MuApp muApp : muApps){
//            System.out.println(o.getCheapestComputeNode(muApp).getId());
//        }
//        int mCont = 0;
//        for (ComputeNode cn : computeNodes){
//            mCont += cn.getMaxMu();
//        }
//        System.out.println(mCont - computeNodes.getFirst().getMaxMu());
